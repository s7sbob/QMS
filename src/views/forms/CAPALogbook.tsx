...
interface CAPALogbookData {
  year: string;
  department: string;
  entries: LogEntry[];
}

const CAPALogbook: React.FC = () => {
  const [formData, setFormData] = useState<CAPALogbookData>({
  ...
  const handleInputChange = (field: keyof CAPALogbookData, value: any) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  return (
    <PageContainer title="CAPA Logbook" description="Logbook for Corrective and Preventive Actions">
      <Breadcrumb title="CAPA Logbook" items={BCrumb} />
      
      <ParentCard title="CAPA Logbook">
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell sx={{ fontWeight: 'bold' }}>CAPA No.</TableCell>
                      ...
                      <TableRow key={index}>
                        ...
                        <TableCell>
                          <CustomTextField
                            ...
                            size="small"
                            value={entry.capaNo}
                            onChange={(e: { target: { value: any; }; }) => handleEntryChange(index, 'capaNo', e.target.value)}
                          />
                        </TableCell>
                        <TableCell>
                          <CustomTextField

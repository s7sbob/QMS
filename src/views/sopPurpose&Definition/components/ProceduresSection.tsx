...
const ProceduresSection: React.FC<ProceduresSectionProps> = ({ initialData }) => {
  ...
  const handleDoubleClick = () => {
    ...
    axiosServices
      ...
      .catch((error) =>
        console.error("Error fetching historical procedures:", error)
      );
  };
  ...
  return (
    <Box sx={{ mt: 2, fontFamily: "Arial, sans-serif" }}>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} fullWidth maxWidth="md">
        <DialogTitle>تفاصيل Procedures</DialogTitle>
            ...
            <Box sx={{ mb: 2, border: "1px solid #ccc", p: 2, borderRadius: 1 }}>
              <Stack spacing={2}>
                ...
                <Typography variant="body2">
                  <strong>Version:</strong> {procedure.Version}
                </Typography>
                <Typography variant="body2">
                  <strong>Crt_Date:</strong> {procedure.Crt_Date}
                </Typography>
                <Typography variant="body2">
                  <strong>Modified_Date:</strong> {procedure.Modified_Date || "N/A"}
                </Typography>
                <Typography variant="body2">
                  <strong>Crt_by:</strong> {procedure.Crt_by}
                </Typography>
                <Typography variant="body2">
                  <strong>Modified_by:</strong> {procedure.Modified_by || "N/A"}
                </Typography>
              </Stack>
            </Box>
          )}

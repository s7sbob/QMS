...
const NonConformityReport: React.FC = () => {
  const [formData, setFormData] = useState<NonConformityData>({
    ncrNo: '',
    reportDate: null,
    reportedBy: '',
    department: '',
  ...
  const handleInputChange = (field: keyof NonConformityData, value: any) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  return (
    <PageContainer title="Non-Conformity Report" description="Non-Conformity Report Form">
      <Breadcrumb title="Non-Conformity Report" items={BCrumb} />
      
      <ParentCard title="Non-Conformity Report">
            ...
            <CardContent>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  <CustomFormLabel htmlFor="ncrNo">NCR No.</CustomFormLabel>
                  <CustomTextField
                    id="ncrNo"
                    variant="outlined"
                    fullWidth
                    value={formData.ncrNo}
                    onChange={(e: { target: { value: any; }; }) => handleInputChange('ncrNo', e.target.value)}
                  />
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  <CustomFormLabel htmlFor="nonConformityType">Non-Conformity Type</CustomFormLabel>
                  <FormControl fullWidth>
                    <Select
                      value={formData.nonConformityType}
                      onChange={(e) => handleInputChange('nonConformityType', e.target.value)}
                    >
                ...
                <Grid item xs={12}>
                  <CustomFormLabel htmlFor="description">Description of Non-Conformity</CustomFormLabel>
                  <CustomTextField
                    id="description"
                    variant="outlined"
                    fullWidth
